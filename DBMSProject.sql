...
/* Admin tables stores the credentials for every admin */
CREATE TABLE Admin (
...
/* Allotment stores the allotment details for every room*/
...
/* Stores all the details of every wing */
CREATE TABLE Wing (
...
/* Stores all the details of every hostel */
CREATE TABLE Hostel (
...
/* Stores all the details of every room */
CREATE TABLE Room (
...
INSERT INTO Wing (wing_id, wing_rep_name, capacity, p1, p2, p3, status)
VALUES
...
INSERT INTO Freshman (personality_traits)
VALUES
 ('1'),
 ('13'),
 ('23'),
